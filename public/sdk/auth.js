...
class CentrumLogowania {
     ...
     */
    static protect({ clientId, appId, authUrl = 'http://localhost:3002', onLogin, style = {} }) {
        ...
        if (sdk.isAuthenticated()) {
            // ZALOGOWANY
            console.log("SDK: Użytkownik zalogowany.");
            ...
            // NIEZALOGOWANY
            console.log("SDK: Użytkownik niezalogowany.");
...
class CentrumLogowaniaInternal {
    ...
    renderLoginScreen(parentElement, elementIdToInsertBefore) {
        ...
        wrapper.className = "flex flex-col items-center justify-center p-8 text-center space-y-4 animate-in fade-in zoom-in duration-300";
        ...
        btn.className = "mt-4 px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors shadow-sm";
