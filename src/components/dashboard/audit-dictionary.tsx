...
const categories = [
  ...
  {
    id: 'setup_code',
    nameEN: 'Quick Connect',
    namePL: 'Quick Connect',
    icon: KeyRound,
    color: 'bg-amber-100 text-amber-700 border-amber-400',
    description: 'Operacje na kodach Quick Connect do szybkiego podłączenia aplikacji.',
    actions: [
      {
        id: 'setup_code_generate',
        nameEN: 'setup_code_generate',
        namePL: 'Generowanie kodu',
        description: 'Wygenerowano nowy kod Quick Connect do konfiguracji zewnętrznej aplikacji.',
      },
      {
        id: 'setup_code_use',
        nameEN: 'setup_code_use',
        namePL: 'Użycie kodu',
        description: 'Kod Quick Connect został użyty do skonfigurowania aplikacji.',
      },
      {
        id: 'setup_code_delete',
        nameEN: 'setup_code_delete',
        namePL: 'Usunięcie kodu',
        description: 'Usunięto nieużyty kod Quick Connect przed jego wygaśnięciem.',
      },
      {
        id: 'setup_code',
        nameEN: 'setup_code',
        namePL: 'Operacja na kodzie',
        description: 'Ogólna operacja na kodzie Quick Connect (legacy).',
      },
    ],
  },
  {
