...
export const LogoutButtons = () => {
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      <Button variant="destructive" onClick={handleGlobalLogout} disabled={isPending}>
        {isPending ? (
          <Loader2 className="w-4 h-4 mr-2 animate-spin" suppressHydrationWarning />
        ) : (
          <ShieldAlert className="w-4 h-4 mr-2" suppressHydrationWarning />
        )}
