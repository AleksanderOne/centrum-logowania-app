    ...
    <html lang="pl">
      <body className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Wystąpił poważny błąd</h1>
          <p className="text-gray-600 mb-6">
            Przepraszamy, aplikacja napotkała nieoczekiwany problem.
          </p>

          {error.digest && <p className="text-xs text-gray-400 mb-6">Kod błędu: {error.digest}</p>}
